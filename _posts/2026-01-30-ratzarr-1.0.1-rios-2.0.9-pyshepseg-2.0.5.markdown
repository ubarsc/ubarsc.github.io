...
work with any .zarr file - only ones created by RatZarr iteself. Most
users won't use this project directly - either via RIOS and/or pyshepseg.
Not that we aren't talking about saving imagery into a .zarr file -
just the RAT.
...
You then would presumeably do more processing with the data in the .zarr
